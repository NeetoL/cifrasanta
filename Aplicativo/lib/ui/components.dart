...
class SongRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DecoratedBox(
    decoration: BoxDecoration(
      border: Border(bottom: BorderSide(color: SaintColors.divider)),
    ),
    child: Row(
      children: [
        SizedBox(
        ...
        IconButton(
          ...
          icon: Icon(
            ...
            size: 21,
            color: favorite ? SaintColors.gold : SaintColors.subtle,
          ),
        ),
      ],
    ),
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          subtitle,
          style: TextStyle(color: SaintColors.muted, fontSize: 13, height: 1.4),
        ),
      ],
    ),
  );
    ...
    child: Column(
      children: [
        ...
        Text(
          message,
          textAlign: TextAlign.center,
          style: TextStyle(color: SaintColors.muted, fontSize: 13, height: 1.5),
        ),
        if (action != null && onAction != null) ...[
